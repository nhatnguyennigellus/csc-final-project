...
<script type="text/javascript">
	...
	function validate(name) {
		...
		if(control.attr("id") == "phone1" || control.attr("id") == "phone2"){
		...
		else if (control.val() == "" && control.attr("id") != "customerMiddleName") {
			checkSpan.addClass("label label-danger");
...
<body>
	...
	<div class="panel-body">
		<form id="customerForm" action="updateCustomer" method="post">
			...
			First Name: <input class="form-control" style="width: 15%; display: inline; margin-right: 2%; margin-top: 5px; margin-left: 2%;" type="text" onkeypress="return (event.charCode >= 65 && event.charCode <= 90) || (event.charCode >= 97 && event.charCode <= 122) || (event.charCode == 32)" id="customerFirstName" name="customerFirstName" value="${customer.firstName }" onblur="validate('customerFirstName')" /><span id="checkcustomerFirstName" style="width: 100px; height: 34px;"></span>
			Middle Name: <input class="form-control" style="width: 15%; display: inline; margin-right: 2%; margin-left: 2%;" type="text" onkeypress="return (event.charCode >= 65 && event.charCode <= 90) || (event.charCode >= 97 && event.charCode <= 122) || (event.charCode == 32)" id="customerMiddleName" name="customerMiddleName" value="${customer.middleName }" onblur="validate('customerMiddleName')" /><span id="checkcustomerMiddleName" style="width: 100px; height: 34px;"></span>
			Last Name: <input class="form-control" style="width: 15%; display: inline; margin-right: 2%; margin-left: 2%;" type="text" onkeypress="return (event.charCode >= 65 && event.charCode <= 90) || (event.charCode >= 97 && event.charCode <= 122) || (event.charCode == 32)" id="customerLastName" name="customerLastName" value="${customer.lastName }" onblur="validate('customerLastName')" /><span id="checkcustomerLastName" style="width: 100px; height: 34px;"></span><br>
			...
			Phone 1: <input class="form-control" style="width: 15%; display: inline; margin-right: 2%; margin-top: 5px; margin-left: 2%;" type="text" onkeypress="return event.charCode >= 48 && event.charCode <= 57" id="phone1" name="phone1" value="${customer.phone1 }" onblur="validate('phone1')" /><span id="checkphone1" style="width: 100px; height: 34px;"></span>
			Phone 2: <input class="form-control" style="width: 15%; display: inline; margin-right: 2%; margin-left: 2%;" type="text" onkeypress="return event.charCode >= 48 && event.charCode <= 57" id="phone2" name="phone2" value="${customer.phone2 }" onblur="validate('phone2')" /><span id="checkphone2" style="width: 100px; height: 34px;"></span><br>
			...
			ID Card Number: <input class="form-control" style="width: 15%; display: inline; margin-right: 2%; margin-left: 2%;" type="text" onkeypress="return event.charCode >= 48 && event.charCode <= 57" id="idCard" name="idCard" value="${customer.idCardNumber }" onblur="validate('idCard')" /><span id="checkidCard" style="width: 100px; height: 34px;"></span><br>
			...
			<div class="form-group">
				...
				<div style="width: 400px; float: left;">
					...
					Interest<br> <input class="form-control"
						style="width: 20%; display: inline;" type="text" id="interest"
					...
					<select id="state" name="state" class="form-control"
						...
						style="width: 20%; display: inline;" type="text" id="interestId"
						name="interestId" value="${account.interestRate.id }" readonly="readonly"/><br>
					<br>
				</div>
				<div style="width: 100%; float: left;"><input class="btn btn-primary" type="submit" value="Save Changes"></div>
				${notify }
			</div>
		</form>
		</div>
